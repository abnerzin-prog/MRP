📘 Mini-ERP de Estoque (com SQLite)
...
Este projeto foi desenvolvido como parte da atividade de programação, com o objetivo de simular um pequeno módulo de estoque inspirado em sistemas ERP.
A proposta foi criar um sistema simples, mas funcional, capaz de cadastrar produtos, excluir itens e exibir um relatório com informações do estoque.
...
O arquivo estoque.db é criado automaticamente na primeira execução.
Todos os dados permanecem salvos mesmo depois de fechar o programa.
...
/ (pasta principal)
 ├── erp_estoque.py        # Código principal do sistema
...
Adicionado sistema de cadastro usando SQLite
Implementada exclusão por ID e nome
Criado relatório com alerta de estoque baixo
Adicionado README com documentação completa
